 ...
 * about their dog's age, and stored the data into an array (one array for
 * each). For now, they are just interested in knowing whether a dog is an
 * adult or a puppy. A dog is an adult if it is at least 3 years old, and it's
 * a puppy if it's less than 3 years old.
 *
 ...
 * number 1 is an adult, and is 5 years old") or a puppy ("Dog number 2 is
 * still a puppy 🐶")
 *
