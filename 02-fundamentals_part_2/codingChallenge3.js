 ...
 * calculate tips and total values (bill + tip) for every bill value in the
 ...
 * as an argument. This function calculates the average of all numbers in the
 * given array. This is a DIFFICULT challenge (we haven't done this before)!
 * Here is how to solve it:
 * 4.1. First, you will need to add up all values in the array. To do the
 * addition, start by creating a variable 'sum' that starts at 0. Then loop
 * over the array using a for loop. In each iteration, add the current value
