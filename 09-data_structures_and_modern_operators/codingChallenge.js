 ...
 * are field players. For Bayern Munich (team 1) create one variable ('gk')
 * with the goalkeeper's name, and one array ('fieldPlayers') with all the
...
// 4.
const players1Final = [...players1, "Thiago", "Coutinho", "Perisić"];
...
// 7.
const _team1 = team1 < team2 && game.team1;
const _team2 = team1 > team2 && game.team2;
console.log(`${_team1 || _team2} is more likely to win`);
